...
tagline: "Welcome to Nimiq Simple Faucet. A self-hosted, stable (1.x) faucet / payout service for Nimiq with 9 pluggable abuse-prevention layers (rate-limiting on by default; others opt-in) and 7 SDKs."
...
adventures:
  ...
  - number: 3
    ...
    time: "~2 hr"
    details: "Exercise every feature — server, admin dashboard, claim UI, 5 examples, 7 SDKs, CLI tools, MCP server, 9 abuse layers."
